...
class TestSrc:
    def test_average_prices(self):
        df_merged_1 = pd.DataFrame(
            [
                ["cat_1", 6.8, None, None, None, 123, None],
                ["cat_2", 6.2, None, None, None, 123, None],
            ],
            columns=COLS,
        )
        df_merged_2 = pd.DataFrame(
            [
                ["cat_1", 8, None, None, None, 123, None],
                ["cat_2", 6.2, None, None, None, 124, None],
            ],
            columns=COLS,
        )
    ...
    def test_list_unique_products_by_categories_by_df(self):
        df_merged_1 = pd.DataFrame(
            [
                ["cat_1", 5.8, None, None, None, 123, None],
                ["cat_1", 6.2, None, None, None, 124, None],
                ["cat_1", 6.2, None, None, None, 125, None],
            ],
            columns=COLS,
        )
        df_merged_2 = pd.DataFrame(
            [["cat_1", 8, None, None, None, 123, None]], columns=COLS
        )
